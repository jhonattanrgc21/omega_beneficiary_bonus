    ...
    <div class="relative">
        ...
        <div class="relative">
            <input v-bind="$attrs" :value="modelValue" @input="$emit('update:modelValue', $event.target.value)"
                ...
                class="w-full px-4 py-3 pr-10 text-sm border rounded-md h-11 text-softBlack font-poppins-regular border-transparentBlack focus:outline-none focus:ring-2 focus:ring-orangeLight" />
